  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <h5><b>How do I sign up for a class?</b></h5>
          <p>To sign up, you must first create an account at the <a href="/sign-in-up">Sign Up page</a>.
            You can then sign up for a class through the <a href="/classes">Classes page</a>.
          </p>

          <h5><b>What is my data being used for?</b></h5>
          ...
          <h5><b>What are the points use for?</b></h5>
          ...
          <h5><b>What is the Unit Exam?</b></h5>
          ...
          <h5><b>Any other questions or site not functioning properly?</b></h5>
