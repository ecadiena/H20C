...
const NavBar = () => {
  ...
  const menuStyle = { marginBottom: '20px', borderBottom: '0.1px solid #D6D8DA' };
  const itemStyle = { paddingLeft: '30px', paddingRight: '30px', color: '#1762A7', fontWeight: 'bold', fontSize: '14px' };
  return (
    <Navbar style={menuStyle}>
      <Container>
        ...
        <Navbar.Collapse id={COMPONENT_IDS.NAVBAR_COLLAPSE}>
          ...
          <Navbar.Brand className="ms-auto justify-content-center" id={COMPONENT_IDS.NAVBAR_LANDING_PAGE} as={NavLink} to="/">
            <img src="/images/uh-logo.png" alt="University of Hawaii Logo" />
          </Navbar.Brand>
