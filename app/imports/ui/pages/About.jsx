    ...
    <div id={PAGE_IDS.ABOUT}>
      <Row fluid className="justify-content-center mx-0">
        <Col fluid md={7} className="p-3 pb-0">
          ...
          “Broadband” is short-hand for an “always-on,” high-speed internet connection provided by a company or other entity known as an “internet service provider” (ISP)  A high-speed home internet connection is no longer a luxury; it is a necessity. 
      ...
      <Row fluid className="justify-content-center mx-0">
        <Col fluid md={7} className="p-3 pb-0 mx-0">
          ...
          Within the continental US other states have access to miles of interconnected terrestrial fiber paths, Hawaiʻi relies on the use of submarine fiber to provide connectivity from the rest of the world to the Islands, with terrestrial and interisland submarine fiber reinforcing the local delivery of broadband. 
          ...
          As a result, Hawaiʻi’s strategy largely focuses on the importance of developing the state’s existing middle mile infrastructure and future middle mile infrastructure with today’s available funding in order to create a robust, future-proof broadband landscape that can support ongoing and future last-mile buildouts. 
          This includes the addition of new carrier-neutral cable landing stations–the first in Hawaiʻi–to enhance the competitive landscape and attract new transpacific submarine fiber build outs to the State, along with a new interisland fiber ring sufficient enough to support Hawaiʻi through 2050.
          </p>
        </Col>
        <Col md={9} fluid className="justify-content-center">
